...
public class APIUtils {
    ...
    public static final String GET_BALANCE_URL = "/vi/getBalance";
    ...
    public APIUtils(String nodeUrl) {
        api = this;
    }
    ...
    public long getBalance(String address) throws IOException {
        ...
        HttpGet request = new HttpGet(nodeUrl + GET_BALANCE_URL);

        HttpResponse response;
        response = client.execute(request);
        String responseBody = EntityUtils.toString(response.getEntity());
        Log.d("NET",  "Get Balance: " + responseBody);
